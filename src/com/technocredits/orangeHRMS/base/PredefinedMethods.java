...
public class PredefinedMethods {
	...
	protected List<WebElement> getElements(String locatorType, String locator, boolean isWaitRequired) {
		...
		case "PARILALLINKTEXT" :
			if(isWaitRequired)
				elementList = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.partialLinkText(locator)));	
			else
	...
	protected void enterText(String locatorType, String locator, boolean isWaitRequired, String text) {
		...
		if(element.isEnabled())
			...
			//throw new ElementNotEnabled("Element was not enabled for Locator Type " +locatorType+ " for locator value "+locator);
			System.out.println("Element was not enabled for Locator Type " +locatorType+ " for locator value "+locator);
		}
	}
